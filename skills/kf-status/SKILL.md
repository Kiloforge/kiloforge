...
Read `.agent/conductor/product.md` and extract:
...
Read `.agent/conductor/tracks.md` and parse:
...
For each track in `.agent/conductor/tracks/`:

Read `.agent/conductor/tracks/{trackId}/plan.md`:
...
Read `.agent/conductor/tracks/{trackId}/spec.md`:
