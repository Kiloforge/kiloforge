...
- [x] Add `go.opentelemetry.io/otel`, SDK, and chosen exporter to `go.mod`
...
- [x] **File:** `backend/internal/core/port/tracer.go`
...
- [x] **File:** `backend/internal/adapter/tracing/otel_tracer.go`
...
- [x] **File:** `backend/internal/adapter/agent/spawner.go`
...
- [x] **File:** `backend/internal/adapter/agent/spawner.go` (integrated with monitorAgent)
...
- [x] **File:** `backend/internal/adapter/rest/server.go`
...
- [x] **File:** `backend/api/openapi.yaml`
...
- [x] **File:** `backend/internal/adapter/rest/api_handler.go` (integrated with existing handler)
...
- [x] **File:** `backend/internal/adapter/rest/api_handler_test.go`
...
- [x] **File:** `frontend/src/pages/TracePage.tsx`
...
- [x] **File:** `frontend/src/pages/OverviewPage.tsx`
...
- [x] Test end-to-end: spawn agent → record events → query trace API → verify span tree
- Test disabled tracing (no-op tracer, no errors)
- Test exporter flush on shutdown

### Task 5.2: Documentation
- [x] Update README with tracing configuration section
