...
### Task 1.1: Inherit request context in WebSocket sessions
...
### Task 1.2: Track OutputRelay goroutine
...
### Task 1.3: Add stale session cleanup
...
### Task 2.1: Add server shutdown coordination
