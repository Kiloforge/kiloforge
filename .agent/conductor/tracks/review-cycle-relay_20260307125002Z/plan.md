...
### Task 1.1: Spawn reviewer on PR opened
...
### Task 1.2: Add Gitea API methods for PR management
...
### Task 1.3: Track review cycle state
...
### Verification 1
- [ ] Reviewer spawned on PR opened
- [ ] PR tracking records reviewer info
- [ ] Cycle counting works
- [ ] Tests pass

## Phase 2: Review Response Handling

### Task 2.1: Handle review approved
...
### Task 2.2: Handle changes requested
...
### Task 2.3: Handle developer push (synchronize)
...
### Verification 2
- [ ] Approval resumes developer
- [ ] Changes requested resumes developer with feedback
- [ ] Push triggers re-review
- [ ] Escalation at cycle limit
- [ ] Tests pass

## Phase 3: CLI and Integration

### Task 3.1: Implement `crelay escalated` command
...
### Verification 3
- [ ] `crelay escalated` shows escalated PRs
