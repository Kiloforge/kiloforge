...
// DiffLineType defines model for DiffLine.Type.
...
// GetProjectDiffParams defines parameters for GetProjectDiff.
type GetProjectDiffParams struct {
	// Branch Branch name to diff against main
	Branch string `form:"branch" json:"branch"`

	// MaxFiles Maximum number of files to return (0 for unlimited)
...
type ServerInterface interface {
	...
	// List active worktree branches for a project
	// (GET /api/projects/{slug}/branches)
	GetProjectBranches(w http.ResponseWriter, r *http.Request, slug string)
...
func (siw *ServerInterfaceWrapper) GetAgentLog(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindQueryParameter("form", true, false, "lines", r.URL.Query(), &params.Lines)
	if err != nil {
...
func (siw *ServerInterfaceWrapper) RemoveProject(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindQueryParameter("form", true, false, "cleanup", r.URL.Query(), &params.Cleanup)
	if err != nil {
...
// GetProjectBranches operation middleware
func (siw *ServerInterfaceWrapper) GetProjectBranches(w http.ResponseWriter, r *http.Request) {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetProjectBranches(w, r, slug)
	}))
...
// GetProjectDiff operation middleware
func (siw *ServerInterfaceWrapper) GetProjectDiff(w http.ResponseWriter, r *http.Request) {
	...
	// Parameter object where we will unmarshal all parameters from the context
	var params GetProjectDiffParams
	...
	// ------------- Optional query parameter "max_files" -------------

	err = runtime.BindQueryParameter("form", true, false, "max_files", r.URL.Query(), &params.MaxFiles)
	if err != nil {
		siw.ErrorHandlerFunc(w, r, &InvalidParamFormatError{ParamName: "max_files", Err: err})
		return
	}

	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetProjectDiff(w, r, slug, params)
	}))
...
func (siw *ServerInterfaceWrapper) ListTraces(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindQueryParameter("form", true, false, "track_id", r.URL.Query(), &params.TrackId)
	if err != nil {
...
type GetProjectBranchesRequestObject struct {
	Slug string `json:"slug"`
}

type GetProjectBranchesResponseObject interface {
	VisitGetProjectBranchesResponse(w http.ResponseWriter) error
}

type GetProjectBranches200JSONResponse []BranchInfo

func (response GetProjectBranches200JSONResponse) VisitGetProjectBranchesResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(200)
...
type GetProjectBranches404JSONResponse ErrorResponse

func (response GetProjectBranches404JSONResponse) VisitGetProjectBranchesResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(404)
...
type GetProjectBranches500JSONResponse ErrorResponse

func (response GetProjectBranches500JSONResponse) VisitGetProjectBranchesResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(500)
...
type GetProjectDiffRequestObject struct {
	Slug   string `json:"slug"`
	Params GetProjectDiffParams
}

type GetProjectDiffResponseObject interface {
	VisitGetProjectDiffResponse(w http.ResponseWriter) error
}

type GetProjectDiff200JSONResponse DiffResponse

func (response GetProjectDiff200JSONResponse) VisitGetProjectDiffResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(200)
...
type GetProjectDiff400JSONResponse ErrorResponse

func (response GetProjectDiff400JSONResponse) VisitGetProjectDiffResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(400)
...
type GetProjectDiff404JSONResponse ErrorResponse

func (response GetProjectDiff404JSONResponse) VisitGetProjectDiffResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(404)
...
type GetProjectDiff500JSONResponse ErrorResponse

func (response GetProjectDiff500JSONResponse) VisitGetProjectDiffResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(500)
...
type StrictServerInterface interface {
	...
	// List active worktree branches for a project
	// (GET /api/projects/{slug}/branches)
	GetProjectBranches(ctx context.Context, request GetProjectBranchesRequestObject) (GetProjectBranchesResponseObject, error)
	// Get structured diff between a branch and main
	// (GET /api/projects/{slug}/diff)
...
// GetProjectBranches operation middleware
func (sh *strictHandler) GetProjectBranches(w http.ResponseWriter, r *http.Request, slug string) {
	var request GetProjectBranchesRequestObject

	request.Slug = slug

	handler := func(ctx context.Context, w http.ResponseWriter, r *http.Request, request interface{}) (interface{}, error) {
		return sh.ssi.GetProjectBranches(ctx, request.(GetProjectBranchesRequestObject))
	}
	for _, middleware := range sh.middlewares {
		handler = middleware(handler, "GetProjectBranches")
	}
	...
	if err != nil {
		sh.options.ResponseErrorHandlerFunc(w, r, err)
	} else if validResponse, ok := response.(GetProjectBranchesResponseObject); ok {
		if err := validResponse.VisitGetProjectBranchesResponse(w); err != nil {
			sh.options.ResponseErrorHandlerFunc(w, r, err)
		}
	} else if response != nil {
		sh.options.ResponseErrorHandlerFunc(w, r, fmt.Errorf("unexpected response type: %T", response))
...
// GetProjectDiff operation middleware
func (sh *strictHandler) GetProjectDiff(w http.ResponseWriter, r *http.Request, slug string, params GetProjectDiffParams) {
	var request GetProjectDiffRequestObject

	request.Slug = slug
	request.Params = params

	handler := func(ctx context.Context, w http.ResponseWriter, r *http.Request, request interface{}) (interface{}, error) {
		return sh.ssi.GetProjectDiff(ctx, request.(GetProjectDiffRequestObject))
	}
	for _, middleware := range sh.middlewares {
		handler = middleware(handler, "GetProjectDiff")
	}
